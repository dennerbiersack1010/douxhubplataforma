...
Conduzir uma conta autenticada sem vínculo ativo pelas cinco etapas de dados do onboarding, preservando o progresso entre atualizações de página e sessões. A sexta etapa informa que os dados estão preparados, sem criar ainda a clínica ou a unidade.
...
6. dados preparados e revisão das etapas salvas.
...
- a sexta etapa não conclui a criação da clínica;
